...
class BaseInput extends Component {
  constructor(props) {
    ...
    if (this.props.onFocus) this._onFocus = props.functions[props.onFocus].bind();
    if (this.props.onBlur) this.onBlurFunc = props.functions[props.onBlur].bind();
    if (this.props.onChange) this.onChangeFunc = props.functions[props.onChange].bind();
    this._onBlur = () => {
